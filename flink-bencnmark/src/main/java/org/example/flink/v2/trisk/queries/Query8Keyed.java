...
import org.example.flink.v2.trisk.sources.keyed.KeyedAuctionSourceFunction;
import org.example.flink.v2.trisk.sources.keyed.KeyedPersonSourceFunction;
...
public class Query8Keyed {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // set up the execution environment
//        env.setStateBackend(new FsStateBackend("/Users/zhangyang/experiment/CReSt/flink-bencnmark/checkpoint"));
