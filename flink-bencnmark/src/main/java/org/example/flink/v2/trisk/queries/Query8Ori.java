...
import org.example.flink.v2.trisk.sources.AuctionSourceFunction;
import org.example.flink.v2.trisk.sources.PersonSourceFunction;
...
public class Query8Ori {



    private static final Logger logger  = LoggerFactory.getLogger(Query8Ori.class);
