...
package org.example.flink.v2.nexmark;

import org.example.flink.common.ConfigToolV2;
import org.example.flink.v2.nexmark.sinks.DummyLatencyCountingSink;
import org.example.flink.v2.nexmark.sources.BidSourceFunction;
...
public class Query11 {
    ...
    private static final class MaxLogEventsTrigger extends Trigger<Bid, TimeWindow> {
        ...
        @Override
        public TriggerResult onElement(Bid element, long timestamp, TimeWindow window, TriggerContext ctx) throws Exception {
